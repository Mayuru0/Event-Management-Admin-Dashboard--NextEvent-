...
// Component to fetch and display user info
...
// ✅ Correct component name (uppercase)
const AdminEventsRejected: React.FC<AdminEventsPendingProps> = ({ onView }) => {
  ...
  if (isLoading)
    return <p className="text-center text-xl font-semibold text-blue-600">Loading events...</p>;

  if (isError)
    return <p className="text-center text-lg font-semibold text-red-500">Failed to load events.</p>;

  return (
    <div className="min-h-screen p-6">
      <div className="mt-6 rounded-lg bg-white p-6 shadow-lg">
        <h3 className="mb-4 text-xl font-semibold text-[#1F1F1F]">Rejected Events</h3>
