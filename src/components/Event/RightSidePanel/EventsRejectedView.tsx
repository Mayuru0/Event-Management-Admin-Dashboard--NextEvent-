...
interface EventsRejectedViewProps {
  event: Event | null;
  onClose: () => void;
}

const EventsRejectedView: React.FC<EventsRejectedViewProps> = ({ event, onClose }) => {
      ...
      <div className="w-[476px] border-t pt-4">
        <div className="flex gap-3">
          ...
          <button
            type="button"
            onClick={handleClose}
            className="flex-1 rounded-md border border-gray-300 py-2.5 text-sm font-bold text-gray-600 hover:bg-gray-50 transition-colors"
          >
            Close
          </button>
          <button
...
export default EventsRejectedView;
